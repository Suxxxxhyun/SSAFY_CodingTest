...
// 여기서 부분수열이란 수열에서 일부 숫자를 선택해서 만든 또 다른 수열이며, 감소하는 부분수열이란 숫자가 점점 감소하는 부분수열을
// 의미합니다. 예를 들어, 45, 50, 25, 10, 18, 20 이라는 수열이 있다고 가정하면, 45, 25, 10 같은 수열은 감소하는
// 부분수열이지만 50, 20, 10은 순서대로 나오지 않으므로 부분수열이 아닙니다. 45, 50, 25, 10, 18, 20 수열에서 가장
// 긴 감소하는 부분수열은 45, 25, 10이 됩니다.
